...
// It has the core creative content needed for the test.
  ...
  chapters: [
    {
      ...
      imagePrompts: [
        ...
        "A dense fog rolling in from the ocean, obscuring the base of a tall lighthouse, eerie, lovecraftian horror"
      ],
      generatedImages: [
    ...
    },
    {
      ...
      imagePrompts: [
        ...
        "The interior of a lighthouse lantern room, the giant lens reflecting an empty, swirling void instead of light",
        "A vast, dark ocean under a starless sky, with a subtle, ominous glow coming from the deep below, cosmic horror"
      ],
      generatedImages: [
